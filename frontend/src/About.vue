...
Найкращий показник кадрового потенціалу серед коледжів України: 28% викладачів мають науковий ступінь доктора філософії (кандидата наук) або доктора наук; 31% - присвоєно педагогічне звання «викладач-методист».</p></center>
    <Footer />
</template>
